...
* Fix - Add focus indicator to select and text inputs on Cart/Checkout block pages
...
* Fix - Add To Cart Form: hide stepper when product is sold individually.
...
* Fix - Ensure the URL for the transitional page is correct whenever accessing it for the very first time after completing the CYS flow
* Fix - Fix "Coming soon" bar styles are missing in several themes
...
* Fix - Fix an issue in which certain incompatible payment gatways wouldn't surface in the Checkout editor page.
...
* Fix - Fix Upsells and Cross-Sells selection changes depending on block position #52235
* Fix - Fix wrong CSS class used by product grids that breaks theme.json styling.
...
* Fix - Make coupon code errors announced by screen readers
...
* Fix - Remove siteground-specific cache invalidation.
...
* Fix - Set a fixed color to Select2 dropdown options
...
* Add - Product Collection: Add "order" reference for "Upsells" and "Cross-Sells" collections.
...
* Update - Product Collection: Add "Products" suffix to some of the collection names
...
* Update - Remove OnboardingThemes.php and prevent synchronous WCPayPromotion api call
...
* Dev - E2E tests: Update relevant e2e tests to be compatible with the upcoming changes in WP 6.7
...
* Tweak - Adjust copy in the cart sidebar when the shipping calculator is not enabled.
...
* Tweak - Fix capitalization of Privacy policy and Terms and conditions
